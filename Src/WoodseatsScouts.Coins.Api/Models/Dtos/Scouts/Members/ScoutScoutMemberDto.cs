...
public class ScoutScoutMemberDto(ScoutMember scoutMember) : ScoutMemberBaseDto(scoutMember)
{
    ...
    public string ScoutSectionCode { get; init; } = scoutMember.ScoutSectionId;
